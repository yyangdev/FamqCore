...
REGENT_EMBED_DESCRIPTION = (
    ...
    "Заявки расматриваются только на сервере Orlando.\n"
    "Уведомление о приглашении на обзвон отправляется в ваш тикет.\n\n"
    "**Срок рассмотрения:** до 48часов.\n"
...
CAPT_FIELDS = [
    ...
    ("Откат сайга и спешик", "Ваши откаты(важно нужно именно два ваших отката)", True, 200),
    ("Откаты MCL каптов и МП", "Ваши откаты в MCL(необезательно но будет плюсом)", False, 200),
]
